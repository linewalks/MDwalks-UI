...
var RadiusGauge = function RadiusGauge(_ref) {
  ...
  var cy = 103;
  var radius = 103;
  var angleScale = linear$1().domain([0, 1]).range([0, 180]);
...
function sankeyCircular () {
  ...
  sankeyCircular.nodeId = function (_) {
    return arguments.length ? (id = typeof _ === 'function' ? _ : constant$4(_), sankeyCircular) : id;
  };

  sankeyCircular.nodeAlign = function (_) {
    return arguments.length ? (align = typeof _ === 'function' ? _ : constant$4(_), sankeyCircular) : align;
  };
  ...
  sankeyCircular.nodes = function (_) {
    return arguments.length ? (nodes = typeof _ === 'function' ? _ : constant$4(_), sankeyCircular) : nodes;
  };

  sankeyCircular.links = function (_) {
    return arguments.length ? (links = typeof _ === 'function' ? _ : constant$4(_), sankeyCircular) : links;
  };
  ...
  function SankeyChart(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "initializeSVG", function (d3, _ref2) {
      var width = _ref2.width,
          height = _ref2.height,
          margin = _ref2.margin;
      return d3.select("div#chart_".concat(_this.id)).append('svg').attr('id', _this.id).attr('width', width + margin.left + margin.right).attr('height', height + margin.top + margin.bottom);
    });
